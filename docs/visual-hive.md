...
- Project: hive-specialist-product-proof
- Detected type: static
- Setup profile: free-local
- Package manager: npm
- Selected package path: .
- Frameworks: none
- Config path: visual-hive.config.yaml
- Playwright setup: missing
...
- Scripts: none
- Config files: none
- No Playwright dependency was detected.
...
- Recommended target: localPreview (url)
- Target URL: http://127.0.0.1:4173
- Install command: not configured
- Build command: not configured
- Serve command: not configured
- Setup commands: none
- Services: none
- Teardown commands: none
- Estimated PR runtime: 2 minute(s)
...
- Estimated scheduled runtime: 4 minute(s)
- Scheduled secrets by name: none
- External network allowed by recommendation: no
...
- Reasons: No known stable app-shell data-testid was detected, so the starter contract uses body until a project-owned shell selector is added., Desktop and mobile screenshots give the first PR-safe visual regression lane.

## Detected Route Hints

No app route hints were detected.
...
- Argos: future. Start with local artifacts. Enable hosted review later only if the team needs shared screenshot review/history. Required env names: ARGOS_TOKEN. External by default: no.
...
- Evidence: project=hive-specialist-product-proof, packageManager=npm, frameworks=none, scripts=build, serve, test, routes=0, playwright=missing
...
- Action: Add or fix a dev, preview, or start script before enabling required PR checks.
- Command: none
- Evidence: target=localPreview, kind=url, confidence=low, url=http://127.0.0.1:4173
...
- Command: none
- Evidence: contracts=1, selectors=1, screenshots=2
...
- External screenshots per run by default: 0
- Estimated monthly external screenshots: 0
- CI runtime class: cheap
...
- [info] Detected project type static with npm commands. Evidence: No major frontend framework dependency detected.
- [warning] No data-testid selectors were found. Add project-owned selectors before relying on visual contracts for precise diagnostics.
- [warning] No local preview command was found. Add a dev, preview, or start script before enabling deterministic PR runs.
- [info] No Playwright dependency, script, or config file was detected. Visual Hive can still generate setup, but the target repo should install Visual Hive/Playwright before CI runs.
- [warning] No preview/dev/start script was detected for a command target.
- [warning] Starter contract uses body because no known stable app-shell data-testid was detected.
- [warning] No Playwright setup was detected in the target repo.
